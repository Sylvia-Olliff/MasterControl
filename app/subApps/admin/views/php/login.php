<?php
	...
	if (isset($_POST['loginData'])) {
		...
		$userData[0] = strtoupper($userData[0]);

		$loggedIn = i5_connect("172.27.80.110", $userData[0], $userData[1]);

		if ($loggedIn) {
			$options = array('i5_naming' => DB2_I5_NAMING_ON);

			$execSQL = "SELECT COUNT(*) FROM QS36F/FSECF001 WHERE SEUSER = '{$userData[0]}' AND SEPGM = 'RBNLADMINW'";
